        ...
        <section class="wrap_grille_img">
            ...
            <section class="gallery">
                ...
                <div class="gallery__item">
                    ...
                    <img class="gallery__img" src="<?= wp_get_attachment_url($arr[0]) ?>" alt="" />
                    <label for="img-2" class="gallery__thumb"><img src="<?= wp_get_attachment_url($arr[0]) ?>" alt="" /></label>
                </div>
                <div class="gallery__item">
                    <input type="radio" id="img-3" name="gallery" class="gallery__selector" />
                    <img class="gallery__img" src="<?= wp_get_attachment_url($arr[1]) ?>" alt="" />
                    <label for="img-3" class="gallery__thumb"><img src="<?= wp_get_attachment_url($arr[1]) ?>" alt="" /></label>
                </div>
                <div class="gallery__item">
                    <input type="radio" id="img-4" name="gallery" class="gallery__selector" />
                    <img class="gallery__img" src="<?= wp_get_attachment_url($arr[2]) ?>" alt="" />
                    <label for="img-4" class="gallery__thumb"><img src="<?= wp_get_attachment_url($arr[2]) ?>" alt="" /></label>
                </div>
            </section>
