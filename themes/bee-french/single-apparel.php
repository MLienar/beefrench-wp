    ...
    <section class="wrap_grille_img">
        <div class="grille_image_produit">
            <img src="<?= the_post_thumbnail_url() ?>" alt="<?php the_title(); ?>"
                class="one img_product_basket<?= $post->ID; ?>">
            ...
            <form action="#">
                ...
                <div class="cd_form_button">
                    ...
                    <button type="button" class="ajouter <?= $post->ID; ?>">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/code/images/png/icons8-baskets-64.png"
                            alt="sneakers" class="sneakers_basket">
