...
<main>
    <section class="hero">
        <article>
            <img src="./code/images/png/af1.png" alt="AF1 Custom">
            <h1 class="custom_title">CUSTOM</h1>
            <h1 class="af1_title">AF1</h1>
            <img class="hero_img img1" src="./code/images/jpg/custom1.jpeg" alt="AF1 Custom">
            <img class="hero_img img2" src="./code/images/jpg/0b8db10977f4379a889a557055f992bf.png" alt="AF1 Custom">
            <img class="hero_img img3" src="./code/images/png/custom5.png" alt="AF1 Custom">
            <img class="hero_img img4" src="./code/images/jpg/custom4.jpeg" alt="AF1 Custom">
    ...
    <section id="cd_contenu_index">
        <div class="contenu_index_1" data-scroll>
            <img src="./code/images/jpg/custom1.jpeg" alt="AF1 Custom" data-scroll data-scroll-speed="2">
        ...
        <div class="contenu_index_2">
            <div class="sous_div_contenu_2">
                <img src="./code/images/png/custom5.png" alt="AF1 Custom" class="image_index_21" data-scroll
                    data-scroll-speed="2">
            </div>
            <img src="./code/images/jpg/0b8db10977f4379a889a557055f992bf.png" alt="AF1 Custom" class="image_index_22">
        </div>
        <div class="contenu_index_3">
            ...
            <div class="sous_div_contenu_3_bis">
                <img src="./code/images/jpg/custom4.jpeg" data-scroll data-scroll-speed="2">
            </div>
        </div>
        <div class="contenu_index_4">
            <div class="sous_div_contenu_4">
                <img src="./code/images/png/custom5.png" alt="AF1 Custom">
        ...
        <div class="contenu_index_5">
            ...
            <img src="./code/images/jpg/custom4.jpeg" alt="AF1 Custom">
        </div>
    </section>
</main>
<?php wp_footer() ?>