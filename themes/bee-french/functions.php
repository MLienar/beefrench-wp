...
function montheme_register_assets()
{
    ...
    wp_register_script('basket2', get_stylesheet_directory_uri() . '/code/js/basket2.js');
    wp_register_script('gallery', get_stylesheet_directory_uri() . '/code/js/gallery.js');
    wp_register_script('contact', get_stylesheet_directory_uri() . '/code/js/contact.js');
